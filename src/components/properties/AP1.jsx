  ...
  return (
    <>
      ...
      <div className="property-name">
        <h2 className="house-name">{apartmentsData[id - 1].name}</h2>
      ...
      <div className="Grid-info">
        <div className="Grid-more-info">
          <h3>Description</h3>
          <p>{apartmentsData[id - 1].address}</p>
          <h3>Condition</h3>
          <p>{apartmentsData[id - 1].condition}</p>
          <h3>Price</h3>
          <p>{apartmentsData[id - 1].price}</p>
        </div>
      ...
      <div className="location-div">
        ...
        <div className="builder-div">
          ...
          <div className="builder-profile">
            <h2>Posted By:</h2>
            <h3> {apartmentsData[id - 1].builder}</h3>
            <p>Check Profile &#x21C0; </p>
          </div>
        </div>
      </div>
