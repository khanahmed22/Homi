  ...
  return (
    <>
      ...
      <div className="Grid-H">
        <div
          className="Grid-H-components"
          onClick={() => {
            navigate("1");
          }}
        >
          <img src="/images/bal.webp" alt="house-1"></img>
          <h3>White Lotus Town House</h3>
        ...
        >
          <img src="/images/pond.webp" alt="house-2"></img>
          <h3>Daisy Getaway</h3>
          <p>Riverside · 700 Sq ft.</p>
          <p>$80,000</p>
        </div>
        ...
        >
          <img src="/images/house.webp" alt="house-3"></img>
          <h3>Santorini Bungalow</h3>
          <p>Fredericton · 700 Sq ft.</p>
          <p>$45,000</p>
        </div>
        ...
        >
          <img src="/images/w1.webp" alt="house-4"></img>
          <h3>Pearl Bungalow</h3>
          <p>Chicago · 700 Sq ft.</p>
          <p>$50,000</p>
        </div>
        ...
        >
          <img src="/images/wow.webp" alt="house-5"></img>
        ...
        >
          <img src="/images/white.webp" alt="house-6"></img>
          <h3>Auburn Home</h3>
          <p>Riverside · 700 Sq ft.</p>
          <p>$50,000</p>
        </div>
        ...
        >
          <img src="/images/green.webp" alt="house-7"></img>
          <h3>Poppy Home</h3>
          <p>Baku · 200 Sq ft.</p>
          <p>$10,000</p>
        </div>
        ...
        >
          <img src="/images/rent.webp" alt="house-8"></img>
          <h3>Carnation Bungalow</h3>
          <p>Milan · 800 Sq ft.</p>
          <p>$90,000</p>
        </div>
      </div>
